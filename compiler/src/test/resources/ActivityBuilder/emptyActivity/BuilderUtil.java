...
public class BuilderUtil {
  private static final HashMap<Class<? extends Activity>, Class<? extends BaseActivityBuilder>>
  ...
  public static <A extends Activity> BaseActivityBuilder<? extends BaseActivityBuilder, A> createBuilder(
      A activity,
  ...
  public static <A extends Activity, T extends BaseActivityBuilder<T, A>> T smallCreate(A activity,
    ...
    if (sBuilderMap.containsKey(clazz)) {
      try {
        return (T) sBuilderMap.get(clazz)
            .getMethod("create", Activity.class)
  ...
  public static EmptyActivityHelper createHelper(EmptyActivity activity) {
    return new EmptyActivityHelper(activity, true);
  }
}
