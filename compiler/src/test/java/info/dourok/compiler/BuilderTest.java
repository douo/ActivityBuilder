...
public class BuilderTest {
  /**
   * 使用 Builder 注解了 Activity 应该生成 [Activity]Builder 和 [Activity]Helper 两个类
   *
   * @throws Exception
   */
  @Test
            ...
            .compile(
                full(
                    JavaFileObjects.forResource(
                        "ActivityBuilder/emptyActivity/EmptyActivity.java")));
    assertThat(compilation).succeeded();
    assertThat(compilation)
        .generatedSourceFile("test/EmptyActivityBuilder")
        .hasSourceEquivalentTo(
            JavaFileObjects.forResource("ActivityBuilder/emptyActivity/EmptyActivityBuilder.java"));
    assertThat(compilation)
        .generatedSourceFile("test/EmptyActivityHelper")
        .hasSourceEquivalentTo(
            JavaFileObjects.forResource("ActivityBuilder/emptyActivity/EmptyActivityHelper.java"));
    assertThat(compilation)
        .generatedSourceFile("info/dourok/esactivity/BuilderUtil")
        .hasSourceEquivalentTo(
